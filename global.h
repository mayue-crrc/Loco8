...
#define	LIANGDUJIANGDI   "image: url(:/images/images/liangdujiangdi.png);"
#define	LIANGDUZENGJIA   "image: url(:/images/images/liangduzengjia.png);"
#define	CASHISUOPING   "image: url(:/images/images/cashisuoping.png);"
#define	QIEHUANYUYAN   "image: url(:/images/images/qiehuanyuyan.png);"
#define	YUNXING   "image: url(:/images/images/yunxing.png);"
...
#define	WEIHUZHUPINGANXIA   "image: url(:/images/images/weihuzhupinganxia.png);"
#define	XUDIANCHIDIANYA   "image: url(:/images/images/xudianchidianya.png);"
#define	YUANBIANDIANLIU   "image: url(:/images/images/yuanbiandianliu.png);"
#define	WANGYA   "image: url(:/images/images/wangya.png);"
...
{
    //按照导航区的种类，设置多种界面模式。
    uMiddleMainPage = 0,//主界面
    uMiddleTrainData,//机车信息
    uMiddleControl,//机车控制
    uMiddleBrake,//制动模式
    uMiddleDeviceData,//过程数据
    uMiddleSetting,//机车设置
    uMiddleMain,//维护测试
    uMiddleFault,//故障查询
    uTop,
