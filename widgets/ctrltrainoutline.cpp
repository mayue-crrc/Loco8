...
void CtrlTrainOutLine::updateData(QList<QList<bool> > bo, QList<QList<QString> > str)
{
...
/*
void CtrlTrainOutLine::updateData(QList<bool> &activation, QList<bool> &direction, QList<bool> &panto, QList<bool> &gaoya,
                                  QList<bool> &zhuduan, QList<bool> &parking, QList<bool> &traction, QList<bool> &brake)
{
    ...
    setLBLpic(ui->LBLZhuduan,zhuduan,t_style);
    //空气制动
    labels.clear();
...
void CtrlTrainOutLine::updateStringData(unsigned short no, unsigned short kn)
{
    //KN
...
void CtrlTrainOutLine::setLBLpic(QLabel *lbl, QList<bool> status, QList<QString> stylestr)
{
